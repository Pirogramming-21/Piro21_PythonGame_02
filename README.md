...
첫 게임은 게임을 실행한 사람으로 지정되며 <1~5번> 게임 중 하나를 선택하도록 설정되어 있습니다. 1번 지하철 게임은 지훈,  369 게임은 예원, UP & DOWN 게임은 선아, 아이엠그라운드 및 아파트 게임은 화현이가 만든 게임입니다. 이도 마찬가지로 <1~5> 이외의 값을 입력하게 되면 다시 입력하라는 문구가 출력되게 됩니다.
