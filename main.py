...
class Game:
    ...
    def play_game(self):
        print(f'{self.players[0].name}이(가) 좋아하는 랜덤 게임~ 랜덤 게임~ 무슨 게임? ')
        while True:
...
def main_game():
    ...
    print(choice_list)
    while True:
        chosen_num = input("당신의 치사량(주량)은 얼마만큼인가요?(1~5를 선택해주세요): ")
        try:
            player_alcohol = 2 * int(chosen_num)
            if player_alcohol not in [2,4,6,8,10]:
                print("보기에 있는 숫자를 선택해 주세요.")
                continue
            else:
                break
        except:
    ...
    for opponent in opponents:
        print(f"🤗 안녕? 난 {opponent.name}(이)고, 내 주량은 🥃 {opponent.max_alcohol}잔이야 🤗")
    print("~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~")
    # 주인공 + 추가된 랜덤 플레이어들
    gamers = []
    ...
    while True:
        ...
        for gamer in gamers:
            if gamer.is_intoxicated():
                ...
                print(" ____                                      _____                              ")
                print("/\  _`\                                   /\  __`\    ")
                print("\ \ \L\_\     __       ___ ___       __   \ \ \/\ \    __  __     __    _ __")
                print(" \ \ \L_L   /'__`\   /' __` __`\   /'__`\  \ \ \ \ \  /\ \/\ \  /'__`\ /\`'__\ ")
                print("  \ \ \/, \/\ \L\.\_ /\ \/\ \/\ \ /\  __/   \ \ \_\ \ \ \ \_/ |/\  __/ \ \ \/ ")
                print("   \ \____/\ \__/.\_\\ \_\ \_\ \_\\ \____\   \ \_____\ \ \___/ \ \____\ \ \_\ ")
                print("    \/___/  \/__/\/_/ \/_/\/_/\/_/ \/____/    \/_____/  \/__/   \/____/  \/_/ ")
                print("")
                print("~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~")
                print("                                  📣 GAME OVER 📣")
                print("~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~")
        ...
        # 한판 더 할건지 여부 물어보기
        show_game_list()
        print('술게임 진행중! 그만하고 싶으면 "exit"을, 계속하고 싶으면 아무키나 입력해 주세요!:  ', end="")
